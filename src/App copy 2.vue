...
const { selectedShirt, shirtsOptions, changeShirt } = useAvatar()
</script>
    ...
    <div class="container mx-auto grid grid-cols-2 h-screen">
      <div class="bg-white pt-[35px] px-[40.1px]">
        ...
        <div class="grid grid-cols-2 mt-5 gap-[20px] h-[400px] overflow-y-scroll">
          <button
            class="border-2 border-[#AEB7BD] rounded-[10px] h-[179px] flex flex-col items-center"
            v-for="shirt of shirtsOptions"
            @click="changeShirt(shirt.name)"
          >
            ...
            <div class="pt-[39px] pb-[39px] px-[43px]">
              <svg
                width="93"
                height="102"
                viewBox="101 130 177 157"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <SvgIcon :name="shirt.name" />
              </svg>
            </div>
          </button>
        </div>
